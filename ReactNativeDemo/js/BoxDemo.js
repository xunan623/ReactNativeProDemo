    ...
    render () {
        return (
            <View style={[BoxStyles.box, BoxStyles[this.props.width],BoxStyles[this.props.height]]}>
                ...
                <View style={[BoxStyles.bottom,BoxStyles[this.props.classBg]]}><Text>bottom</Text></View>
...
class PaddingBox extends Component {
    render () {
        return (
            <Box childName="paddingBox" height="height200" width="width200" boxName="padding" classBg="bgyellow">{this.props.children}</Box>
        );
    }
};
    ...
    render () {
        return (
            <View style={[BoxStyles.box, BoxStyles.height100]}>
                ...
                <View style={[BoxStyles.widthdasheds]}></View>
                <View style={[BoxStyles.heightdasheds]}></View>
            </View>
        );
    }
}
